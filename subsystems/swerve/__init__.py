"""
SwervePy - A comprehensive swerve drive library for FRC teams using Phoenix 6 and PathPlanner
"""

__version__ = "0.1.0"
__author__ = "SteelRidge Robotics"
__license__ = "MIT"
...
__all__ = ["SwerveSubsystem", "__version__"]
